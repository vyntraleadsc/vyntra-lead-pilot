...
export function buildOpportunities(): Opportunity[] {
  const scCities = [...NOVA_SERRA_REGION_CITIES];
      ...
      sellerId:
        r.s >= 80
          ? i % 3 === 0
            ? "rafael"
            : "lucas"
          : ["lucas", "rafael", "lucas", "rafael", "lucas", "bruno", "rafael", "lucas", "bruno", "felipe"][
              i % 10
            ]!,
      status: r.st,
...
export function buildNotifications(opps: Opportunity[]): AppNotification[] {
  ...
  const list: AppNotification[] = [
    ...
    },
    {
      id: "NT-4",
      kind: "seller",
      title: "Felipe com 3 oportunidades quentes sem resposta",
